...
public class ActivityA extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        activity_nome = getString(R.string.activity_a);

        status_activity = (TextView)findViewById(R.id.status_view_a);
        status_all = (TextView)findViewById(R.id.status_view_all_a);
